...
/** Directs movement of {@link shaunlusk.GfxElements} when moveTo() is called.
* These are created and handled internally in GfxElements.
* @constructor
* @param {shaunlusk.GfxElements} element The element this MoveOrder will be bound to.
...
*/
shaunlusk.MoveOrder = function(element, tx, ty, duration, elementCallback, callback) {
...
*/
shaunlusk.MoveOrder.prototype.start = function() {
...
*/
shaunlusk.MoveOrder.prototype.update = function(time,diff) {
...
*/
shaunlusk.MoveOrder.prototype.end = function () {
  this._end = true;
  this._element.setX(this._tx);
  this._element.setY(this._ty);
  if (shaunlusk.isFunction(this._elementCallback)) this._elementCallback();
  if (shaunlusk.isFunction(this._callback)) this._callback(this._element);
};

/** @private */
shaunlusk.MoveOrder.prototype._timePercent = function (time) {
