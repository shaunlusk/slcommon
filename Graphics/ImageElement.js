...
* <b>Extends</b> {@link shaunlusk.GfxElement}<br />
...
* For animations, see {@link shaunlusk.ImageSprite}
* @constructor
* @param {shaunlusk.Screen} screenContext The parent screenContext
...
* <li>imageRenderer - {@link shaunlusk.ImageRenderer} - Optional.  The ImageRenderer that will draw on the canvas.
...
* </ul>
* @see shaunlusk.GfxElement
* @see shaunlusk.ImageSprite
*/
shaunlusk.ImageElement = function(screenContext, parentLayer, props) {
  props = props || {};
  shaunlusk.GfxElement.call(this, screenContext, parentLayer, props);
  ...
  this._imageRenderer = props.imageRenderer || new shaunlusk.ImageRenderer(screenContext.getScaleX(), screenContext.getScaleY());
};

shaunlusk.ImageElement.prototype = new shaunlusk.GfxElement();
shaunlusk.ImageElement.prototype.constructor = shaunlusk.ImageElement;

/** Return the source Image for this element
* @returns {Image}
*/
shaunlusk.ImageElement.prototype.getImage = function() {return this._image;};

/** Return the width for this element
* @override
* @returns {number}
*/
shaunlusk.ImageElement.prototype.getWidth = function() {return this._width;};

/** Return the height for this element
* @override
* @returns {number}
*/
shaunlusk.ImageElement.prototype.getHeight = function() {return this._height;};

/** Return the starting x point on the source Image for this element
* @returns {number}
*/
shaunlusk.ImageElement.prototype.getSourceX = function() {return this._sx;};

/** Return the starting y point on the source Image for this element
* @returns {number}
*/
shaunlusk.ImageElement.prototype.getSourceY = function() {return this._sy;};

/** Return the width of the subsection of the source Image for this element
* @returns {number}
*/
shaunlusk.ImageElement.prototype.getSourceWidth = function() {return this._sWidth;};

/** Return the height of the subsection of the source Image for this element
* @returns {number}
*/
shaunlusk.ImageElement.prototype.getSourceHeight = function() {return this._sHeight;};
